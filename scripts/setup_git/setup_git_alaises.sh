...
git config --global alias.standup '!git log --since="yesterday" --author="$(git config user.name)" --pretty=format:"%Cred%h%Creset - %s

echo "Git aliases have been successfully configured!"
echo "Type 'git aliases' to see all available aliases."
